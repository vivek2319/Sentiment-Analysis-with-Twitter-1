...
tweets <- searchTwitter("rohingya", n=3000, lang="en")
tw_df <- twListToDF(tweets)

# Labeling our network
classified = cbind(tw_df, rep("rohingya", nrow(tw_df)))
colnames(classified)[ncol(classified)]="classifier"

tw_df = classified

tweets2 <- searchTwitter("india", n=3000, lang="en")
tw_df_2 <- twListToDF(tweets2)


# Labeling our network
classified = cbind(tw_df_2, rep("india", nrow(tw_df_2)))
colnames(classified)[ncol(classified)]="classifier"
